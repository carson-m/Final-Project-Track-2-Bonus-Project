...
class PPOPlannerConfig:
    ...
    max_straight_speed_mps: float = 5.00
    max_lateral_speed_mps: float = 0.45
    max_yaw_rate_radps: float = 1.25
    edge_slowdown_margin_norm: float = 0.35
    max_command_delta: float = 0.35
    use_stability_envelope: bool = True
    heading_speed_penalty: float = 0.08
    lateral_speed_penalty: float = 0.0
    edge_speed_penalty: float = 0.25
    turn_speed_penalty: float = 0.0
    min_speed_cap_scale: float = 0.75
    use_racing_line: bool = True
    inside_line_only: bool = True
    max_line_bias_norm: float = 0.90
    line_vy_gain: float = 0.38
    line_yaw_gain: float = 0.46
    max_line_vy: float = 0.32
    max_line_yaw: float = 0.42
    safe_boundary_margin_norm: float = 0.12
